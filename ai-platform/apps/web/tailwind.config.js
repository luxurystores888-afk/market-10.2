  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'ai': '0 4px 20px rgba(14, 165, 233, 0.15)',
        'crypto': '0 4px 20px rgba(247, 147, 26, 0.15)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'ai-gradient': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        'crypto-gradient': 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)',
      },
      screens: {
        'xs': '475px',
        '3xl': '1600px',
    ...
    function({ addUtilities, addComponents, e, prefix, config }) {
      ...
      const newComponents = {
        ...
        '.btn-primary': {
          ...
          color: 'white',
          '&:hover': {
            backgroundColor: config('theme.colors.primary.600'),
          },
        },
        '.btn-secondary': {
          backgroundColor: config('theme.colors.secondary.500'),
          color: 'white',
          '&:hover': {
            backgroundColor: config('theme.colors.secondary.600'),
          },
        },
        '.card': {
